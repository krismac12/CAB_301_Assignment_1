...
namespace Cab_320_ass1
{
    class Program
    {
        ...
        {
            int time1 = TestIterations(10);
            int time2 = TestIterations(100);
            int time3 = TestIterations(200);
            int time4 = TestIterations(300);
            int time5 = TestIterations(400);
            int time6 = TestIterations(500);
            int time7 = TestIterations(600);
            int time8 = TestIterations(700);
            int time9 = TestIterations(999);
